...
// Define the type for the marketing data
...
export const MarketingPage = ({ data }: { data: MarketingPageData }) => {
  return (
    <div className="bg-white">
      {/* Marketing Title */}
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 md:py-6">
        <h1 className="font-bold font-beckett text-[24px] sm:text-[28px] uppercase leading-[22px] sm:leading-[26px] tracking-[2.4px] sm:tracking-[3.6px] md:text-[45px] md:leading-[38px] md:tracking-[6px] text-black text-center mb-4">
          التسويق
        </h1>
        <p className="font-centra text-gray-600 text-[14px] sm:text-[15px] md:text-[16px] leading-[17px] sm:leading-[18px] md:leading-[19px] text-center max-w-4xl mx-auto mb-6">
          {data.subtitle}
        </p>
      </div>
