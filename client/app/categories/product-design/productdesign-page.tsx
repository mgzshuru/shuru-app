...
// Define the type for the product design data
interface ProductDesignPageData {
  mainArticle: {
    title: string;
    description: string;
    imageAlt: string;
...
export const ProductDesignPage = ({ data }: { data: ProductDesignPageData }) => {
  return (
    <div className="bg-white">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        {/* Latest Product Design News Section */}
