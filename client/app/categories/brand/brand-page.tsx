...
// Define the type for the branding data
interface BrandingPageData {
  mainArticle: {
    title: string;
    description: string;
    imageAlt: string;
...
export const BrandingPage = ({ data }: { data: BrandingPageData }) => {
  return (
...
// Sample data for branding page in Arabic
const sampleBrandingData: BrandingPageData = {
  mainArticle: {
  ...
  sideArticles: [
    {
      title: "شاترستوك تعيد تسمية علامتها التجارية مع التوجه الكامل نحو الذكاء الاصطناعي التوليدي",
      description: "تخلت العلامة التجارية عن شعار أداة البحث القديم لصالح جمالية أنيقة وحديثة.",
      imageAlt: "لوحة معلومات شاترستوك الجديدة"
    },
    {
      title: "الصمت ليس ذهبًا",
      description: "في عصر تراجع الثقة المؤسسية، أصبحت قيادة الرأي للرؤساء التنفيذيين ضرورية الآن.",
      imageAlt: "مكبر صوت بنفسجي"
    }
  ],
  bottomImages: [
    { imageAlt: "قميص ملون بنمط فني" },
    { imageAlt: "ميزان العدالة الذهبي" }
  ],
  latestNews: {
    title: "أحدث أخبار العلامة التجارية",
    items: [
      {
        category: "التصميم",
        title: "آنتي آن تعيد تطوير علامتها التجارية لعالم يضم عددًا أقل من مراكز التسوق",
        description: "تقوم آنتي آن بإصلاح 150 متجرًا بمظهر جديد ومطبخ مفتوح لبيع المزيد من البسكويت والمشروبات والوجبات الخفيفة لجيل الألفية ومستهلكي الجيل زد.",
        imageAlt: "متجر آنتي آن الجديد"
      },
      {
        category: "مجلس تأثير فاست كومباني",
        title: "ضاعف قوة اسم العلامة التجارية بتوقيع صوتي",
        description: "يمنح الصوت العلامات التجارية بداية متقدمة بجدته وردود الفعل الأسرع من المستهلكين.",
        imageAlt: "أشكال ثلاثية الأبعاد ملونة"
      }
    ]
  }
};
...
export default function BrandingPageWrapper() {
  return <BrandingPage data={sampleBrandingData} />;
}