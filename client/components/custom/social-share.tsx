...
export function SocialShare({ title, url, description, slug }: SocialShareProps) {
  ...
  return (
    <div className="border-t border-b border-gray-200 py-6 my-8">
      <h3 className="text-sm font-semibold text-gray-900 mb-4">شارك المقال</h3>
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="flex items-center justify-center w-10 h-10 bg-gray-600 text-white rounded-full hover:bg-gray-700 transition-colors relative"
