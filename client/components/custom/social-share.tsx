    ...
    <div className="border border-gray-200 py-6 px-6 bg-gray-50 rounded-lg">
      <div className="flex items-center gap-3 justify-end" dir="rtl">
        ...
        <a
          ...
          className="flex items-center justify-center w-10 h-10 bg-blue-600 text-white hover:bg-blue-700 transition-colors border border-blue-600 hover:border-blue-700"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-10 h-10 bg-gray-900 text-white hover:bg-gray-800 transition-colors border border-gray-900 hover:border-gray-800"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-10 h-10 bg-green-600 text-white hover:bg-green-700 transition-colors border border-green-600 hover:border-green-700"
        ...
        <button
          ...
          className="flex items-center justify-center w-10 h-10 bg-gray-600 text-white hover:bg-gray-700 transition-colors relative border border-gray-600 hover:border-gray-700"
        ...
        {copied && (
          <span className="text-sm text-green-600 font-medium">تم النسخ!</span>
        )}
      </div>
    </div>
  );
