            ...
            >
              {item.subItems && item.subItems.length > 0 ? (
                <>
                  ...
                  <div className={`fixed left-1/2 -translate-x-1/2 top-[90px] w-[70vw] sm:w-56 max-w-xs bg-black/95 backdrop-blur-md rounded-md shadow-2xl transition-all duration-200 z-[100] max-h-[70vh] overflow-y-auto ${
