  ...
  const handleOAuthLogin = async (provider: 'google' | 'linkedin') => {
    ...
    <div className="space-y-3">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 hover:border-gray-400 bg-white hover:bg-gray-50 transition-all duration-200 text-gray-700 font-medium"
      >
      ...
      >
        ...
        <span>متابعة باستخدام LinkedIn</span>
      </button>
    </div>
  );
}
