...
export interface ApiArticleViewArticleView extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Track article view counts without modifying article content';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    last_viewed: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    magazine_issues: Schema.Attribute.Relation<
      'manyToMany',
      'api::magazine-issue.magazine-issue'
    >;
    newsletters: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    previousPublications: Schema.Attribute.Text &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 1000;
      }>;
    publishedAt: Schema.Attribute.DateTime;
    socialMediaLinks: Schema.Attribute.Text &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 500;
      }>;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog post categories with hierarchical support';
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    additionalSections: Schema.Attribute.DynamicZone<
      ['contact.map-section', 'contact.office-locations', 'contact.faq-section']
    >;
    ...
    formSettings: Schema.Attribute.Component<'contact.form-settings', false> &
      Schema.Attribute.Required;
    heroSection: Schema.Attribute.Component<'contact.hero-section', false> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Dynamic home page with reorderable sections';
...
export interface ApiNewsletterEditionNewsletterEdition
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    pdf_archive: Schema.Attribute.Media<'files'>;
    publishedAt: Schema.Attribute.DateTime;
    sent_at: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'subject'> & Schema.Attribute.Required;
    subject: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 255;
